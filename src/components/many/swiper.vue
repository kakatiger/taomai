...
//            console.log(this.mySlide.left)
            if(parseInt(this.mySlide.left) < -this.maxMove*1900) this.mySlide.left=-1900+'px'
            if(parseInt(this.mySlide.left) > -1900) this.mySlide.left=-this.maxMove*1900+'px'
            this.index+=val
